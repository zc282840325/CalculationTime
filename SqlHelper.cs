...
namespace CalculationTime
{
    public class SqlHelper
    {
        ...
        public List<T2> ExcuteList<T2>(string strSelectCmd, params SqlParameter[] paras)
        {
            //1.创建连接通道
            using (SqlConnection conn = new SqlConnection(connStr))
            {
        ...
        /// <param name="paras"></param>
        /// <returns></returns>
        public SqlDataReader ExcuteDataReader(string strSelectCmd, params SqlParameter[] paras)
        {
